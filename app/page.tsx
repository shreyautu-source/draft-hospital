...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isMenuOpen && (
            <div className="md:hidden pb-4">
              <button
                onClick={() => scrollToSection("hero")}
                className="block w-full text-left py-2 text-amber-100 hover:text-amber-300 transition-colors"
              >
                Home
              </button>
              <button
      ...
      >
        <div className="absolute inset-0">
          <Image
            ...
            alt="Draft Hotel Bir Billing Mountain View"
            fill
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
          ...
          <p className="text-xl sm:text-2xl text-amber-200 mb-8 max-w-3xl mx-auto animate-fade-in-delay drop-shadow-md">
            A boutique stay just minutes from Bir&apos;s paragliding landing
            site, where contemporary comfort meets mountain calm. Wake up to the
            Dhauladhar views, unwind in thoughtfully designed rooms, and
            experience Bir at your own pace.
          </p>
          <a
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-700 max-w-3xl mx-auto">
              Our rooms combine modern comfort with warm hospitality, offering
              everything you need for a relaxing mountain escape. Whether
              you&apos;re travelling solo, as a couple, or with family, every
              stay is crafted to make you feel at home.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-amber-700 mb-4">
                  Spacious rooms with mountain views and modern amenities
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-amber-700 mb-4">
                  Budget-friendly shared spaces perfect for solo travelers
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-amber-700 mb-4">
                  Comfortable spaces designed for families and groups
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-amber-900 mb-6">
                Fresh Food. Mountain Views.
              </h2>
              <p className="text-xl text-amber-700 mb-8">
                Our café serves freshly prepared meals, great coffee, and
                comforting favourites in a relaxed setting. Enjoy delicious food
                while soaking in the peaceful atmosphere of Bir.
              </p>
              <a
                href="tel:+917807585316"
                className="inline-block bg-amber-900 text-amber-100 px-8 py-4 rounded-full font-semibold hover:bg-amber-800 transition-colors duration-300"
            ...
            <div className="grid grid-cols-2 gap-4">
              {cafeImages.map((img, index) => (
                <div
                  key={index}
                  className="h-40 relative rounded-lg overflow-hidden"
                >
                  <Image
                    src={img}
      ...
      <section
        id="experiences"
        className="py-20 bg-gradient-to-b from-amber-50 to-white relative"
      >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center group bg-white/80 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-amber-700">
                Soar above the valley with world-class paragliding
              </p>
            </div>
            ...
            <div className="text-center group bg-white/80 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-amber-700">
                Explore scenic trails and hidden mountain paths
              </p>
            </div>
            ...
            <div className="text-center group bg-white/80 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-amber-700">
                Discover Bir&apos;s vibrant café culture
              </p>
            </div>
            ...
            <div className="text-center group bg-white/80 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-amber-700">
                Witness breathtaking sunsets over the mountains
              </p>
            </div>
            ...
            <div className="text-center group bg-white/80 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-amber-700">
                Immerse yourself in local traditions and monasteries
              </p>
            </div>
            ...
            <div className="text-center group bg-white/80 backdrop-blur-sm rounded-lg p-6 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-amber-700">
                Perfect setup for remote work with mountain views
              </p>
            </div>
          </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-700 max-w-3xl mx-auto">
              Take a glimpse into the spaces, views, and experiences that make
              Draft Hotel Bir Billing special.
            </p>
          </div>
      ...
      <section id="about" className="py-20 relative">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-amber-900 mb-6">
            Welcome to Draft Hotel Bir Billing
          </h2>
          <p className="text-xl text-amber-700 mb-8">
            Draft Hotel Bir Billing is a boutique stay created for travellers
            who appreciate thoughtful design, peaceful surroundings, and genuine
            hospitality. Conveniently located near Bir&apos;s famous paragliding
            landing site, it offers the perfect base to explore the mountains
            while enjoying a comfortable and memorable stay.
          </p>
          <a
            href="#contact"
            onClick={(e) => {
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-700 max-w-3xl mx-auto">
              Have questions or need help planning your visit? We&apos;d love to
              hear from you.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
            ...
            <a
              href="mailto:draft.bir.2026@gmail.com"
              className="text-center group"
            >
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-amber-200 transition-colors duration-300">
                <span className="text-2xl">📧</span>
      ...
      <section className="py-20 relative text-white">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-amber-200 mb-8 drop-shadow-md">
            Comfortable rooms, delicious food, unforgettable experiences, and
            the charm of Bir—all waiting for you.
          </p>
          <a
            href="tel:+917807585316"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <h3 className="text-xl font-bold">Draft Hotel Bir Billing</h3>
              <p className="text-amber-200">Where Stories Begin.</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-amber-900 text-center text-amber-300">
            <p>&copy; 2024 Draft Hotel Bir Billing. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </>
