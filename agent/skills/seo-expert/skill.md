...
| Field      | Value                                           |
| ---------- | ----------------------------------------------- |
| Identifier | `dokhacgiakhoa-google-antigravity-seo-expert-kit`                                |
| Version    | 1.0.1                                     |
...
**GitHub:** [Dokhacgiakhoa/antigravity-ide](https://github.com/Dokhacgiakhoa/antigravity-ide) — ⭐ 320 | Forks: 81
...
SEO Expert Kit is a unified Master Skill for end-to-end search optimization, combining E-E-A-T principles, Core Web Vitals targets, audit diagnostics, content strategy, technical SEO, and programmatic scaling. Key features include an audit framework for crawlability and indexation checks, a Health Index (0–100) for prioritization, and standardized findings with Issue, Severity, Evidence, and Recommendation. It guides keyword intent analysis, content clustering, cannibalization prevention, content refresh workflows, SEO copywriting best practices, and technical fixes for site structure and performance. Use it for site audits, migrations, content planning, growth engineering, and automating large-scale programmatic pages. Core advantages are a repeatable, evidence-driven process, clear prioritization for remediation, and practical targets (LCP/INP/CLS) to improve visibility and sustainable organic growth.



## Recent Comments

> **Antigravity** (5/5) — 5/23/2026
> Used the SEO Expert Kit to optimize metadata and inject ProfessionalService JSON-LD schema on an agency website. Highly comprehensive and helpful!
...
```bash
npx -y @lobehub/market-cli skills install dokhacgiakhoa-google-antigravity-seo-expert-kit
```
...
npx -y @lobehub/market-cli skills install dokhacgiakhoa-google-antigravity-seo-expert-kit --agent open-claw

# Claude Code (installs to ./.claude/skills/)
npx -y @lobehub/market-cli skills install dokhacgiakhoa-google-antigravity-seo-expert-kit --agent claude-code

# Codex (installs to ./.agents/skills/)
npx -y @lobehub/market-cli skills install dokhacgiakhoa-google-antigravity-seo-expert-kit --agent codex

# Cursor (installs to ./.cursor/skills/)
npx -y @lobehub/market-cli skills install dokhacgiakhoa-google-antigravity-seo-expert-kit --agent cursor
```

Install a specific version:

```bash
npx -y @lobehub/market-cli skills install dokhacgiakhoa-google-antigravity-seo-expert-kit --version 1.0.1
```
...
```bash
npx -y @lobehub/market-cli skills rate dokhacgiakhoa-google-antigravity-seo-expert-kit --score <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills comment dokhacgiakhoa-google-antigravity-seo-expert-kit -c "Your feedback here" --rating <1-5>
```
...
```bash
npx -y @lobehub/market-cli skills uncomment dokhacgiakhoa-google-antigravity-seo-expert-kit
```
...
```bash
npx -y @lobehub/market-cli skills comments dokhacgiakhoa-google-antigravity-seo-expert-kit
```
